...
class HomesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create home" do
    assert_difference('Home.count') do
      post homes_url, params: { home: { name: @home.name, poker_player_id: @home.poker_player_id } }
    end
  ...
  test "should update home" do
    patch home_url(@home), params: { home: { name: @home.name, poker_player_id: @home.poker_player_id } }
